...
class RNNModel(object):
    def __init__(self, look_back=1, epochs_purchase=20, epochs_redeem=40, batch_size=1, verbose=2, patience=10,
        ...
        self.purchase = pandas.read_csv('data1.csv', usecols=[1], engine='python')
        self.redeem = pandas.read_csv('data1.csv', usecols=[2], engine='python')
...
if __name__ == '__main__':
    initiation = RNNModel(look_back=40, epochs_purchase=230, epochs_redeem=0, batch_size=16, verbose=2, patience=50,
                          store_result=True)
    initiation.run()
