...
class RNNModel(object):
    ...
    def create_data_set(self, data_set):
        ...
        for i in range(len(data_set) - self.look_back - 30):
            ...
            data_y.append(list(data_set[i + self.look_back+15: i + self.look_back+16, 0]))
...
if __name__ == '__main__':
    initiation = RNNModel(look_back=60, epochs_purchase=70, epochs_redeem=1, batch_size=16, verbose=2, patience=50,
                          store_result=True)
    initiation.run()
