...
class RNNModel(object):
   #初始化函数，参数的初始化
    def __init__(self, look_back=1, epochs_purchase=20, epochs_redeem=40, batch_size=1, verbose=2, patience=10,
        ...
        self.purchase = pandas.read_csv('data/arima_residuals.csv', usecols=[1], engine='python')
...
if __name__ == '__main__':
    initiation = RNNModel(look_back=60, epochs_purchase=100, epochs_redeem=1, batch_size=16, verbose=2, patience=50,
                          store_result=True)
    initiation.run()
